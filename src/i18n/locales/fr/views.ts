export default {
  ...
  analytics: {
    ...
    venueVisits: 'Visites des établissements',
  ...
  workflows: {
    ...
    subtitle: 'Visualisez et contrôlez les flux de travaux et l\'ingestion des établissements',
    availableTitle: 'Flux de travaux disponibles',
    availableSubtitle: 'Lancez des tâches automatisées et configurez leurs paramètres en ligne.',
    startIngest: 'Lancer le flux',
    startModalTitle: 'Démarrer le flux : {name}',
    triggerButton: 'Démarrer',
    triggering: 'Démarrage...',
    activeWorkflows: 'Flux de travaux actifs',
    workflowId: 'ID du flux',
    status: 'Statut',
    step: 'Étape courante',
    created: 'Créé le',
    noWorkflows: 'Aucun flux de travaux en cours.',
    reviewsTitle: 'Tâches en attente de validation (Revue Humaine)',
    table: {
      name: 'Titre de la revue',
      details: 'Détails de l\'élément',
      actions: 'Actions de validation',
    },
    approve: 'Approuver',
    reject: 'Rejeter',
    noPendingReviews: 'Aucun flux en attente de revue.',
    detailsTitle: 'Détails du flux de travail #{id}',
    abort: 'Interrompre',
    delete: 'Supprimer',
    exceptions: 'Exceptions / Erreurs rencontrées',
    noExceptions: 'Aucune erreur enregistrée pour ce flux.',
    logsTitle: 'Journaux d\'exécution du flux',
    noLogs: 'Aucun log enregistré pour ce flux.',
    stillRunning: 'Le workflow est en cours d\'exécution...',
    close: 'Fermer',
  }
}

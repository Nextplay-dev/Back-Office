export default {
  ...
  categorySelector: {
    ...
    description: 'Filter and choose a category for this activity.',
  ...
  iconSelector: {
    ...
    emptyDesc: 'Over 10,000 sport and activity icons available.',
  },
  userSelector: {
    noManagers: 'No managers assigned yet',
    manageAssignments: 'Manage Assignments',
    title: 'Assign Managers',
    description: 'Select one or more users to manage this activity.',

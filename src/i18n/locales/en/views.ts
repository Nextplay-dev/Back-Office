export default {
  ...
  workflows: {
    ...
    subtitle: 'Visualize and control dynamic workflows and venue ingestion pipelines',
    availableTitle: 'Available Workflows',
    availableSubtitle: 'Run automated tasks and customize their parameters online.',
    startIngest: 'Trigger Ingestion',
    startModalTitle: 'Start Workflow: {name}',
    triggerButton: 'Start',
    triggering: 'Starting...',
    ...
    step: 'Current Step',
    created: 'Created At',
    noWorkflows: 'No workflows currently active.',
    reviewsTitle: 'Tasks Awaiting Validation (Human Review)',
    table: {
      name: 'Review Title',
    ...
    approve: 'Approve',
    reject: 'Reject',
    noPendingReviews: 'No tasks awaiting review.',
    detailsTitle: 'Workflow Details #{id}',
    abort: 'Abort',
    delete: 'Delete',
    exceptions: 'Encountered Exceptions / Errors',
    noExceptions: 'No errors logged for this workflow.',
    logsTitle: 'Workflow Execution Logs',
    noLogs: 'No logs recorded for this workflow.',
    stillRunning: 'Workflow is still running...',
    close: 'Close',
  }
}
